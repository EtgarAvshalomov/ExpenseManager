...
const Invite = () => {
    ...
    const handleLinkGeneration = async () => {
        const linkGenerationURL = `${apiUrl}/Auth/Validate-Adult-Token`;
        const generatedLink = `${frontUrl}/Sign-Up/${userDetails?.familyId}/${adultToggle}`;
        setError('');
        try {
            setLoading(true);
        ...
        <div className="container">
            ...
            <form onSubmit={handleLinkGeneration}>
                ...
                <div className="mt-2">
                    ...
                    <input
                        type="text"
                        className="form-control link w-100 w-md-60"
                        id="link"
                        defaultValue={link}
                    />
                </div>
